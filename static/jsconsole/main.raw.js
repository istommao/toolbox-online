!(function (t) {
    ...
    Object.defineProperty(e, "__esModule", { value: !0 }),
      function (t) {
          ...
          if (e) {
            ...
            if (r) {
              ...
              for (i in e)
                e.hasOwnProperty(i) &&
                  (n[
                    W.test(i) ? i.replace(/([A-Z0-9])/, "-$1").toLowerCase() : i
                  ] = e[i]);
            }
          }
        }
        function s(t, e, n) {
          ...
          for (var a = e.childNodes.length; a--; )
            e.childNodes[a] !== i && e.removeChild(e.childNodes[a]);
          var s = r.i(M.c)(t, e, i);
          return (
            e && (e._preactCompatRendered = s && (s._component || { base: s })),
            "function" === typeof n && n(),
            (s && s._component) || s
          );
        }
        function o(t, e, n, i) {
          var a = r.i(M.a)($, { context: t.context }, e),
            o = s(a, n),
        ...
        function u(t) {
          ...
          return (
            !(!e || e.parentNode !== t) && (r.i(M.c)(r.i(M.a)(n), t, e), !0)
          );
        }
        function c(t) {
        ...
        function m(t, e) {
          ...
          var a = t.attributes || t.props,
            ...
            o = [s, e];
          return (
            n && n.length ? o.push(n) : e && e.children && o.push(e.children),
        ...
        function b(t, e) {
          return (
            e._refProxies[t] ||
            (e._refProxies[t] = function (r) {
              e &&
                e.refs &&
                ((e.refs[t] = r),
                null === r && (delete e._refProxies[t], (e = null)));
            })
          );
        }
        function A(t) {
  ...
  function (t, e, r) {
    ...
    function a(t, e, r) {
      return (
        !!e &&
        !!s(e.type, t) &&
        ("undefined" === typeof r || H.shallowEqual(e, r))
      );
    }
    function s(t, e) {
      if (t === e) return !0;
      ...
      if (r) {
        if (r[0] === t) return !0;
        for (
          var n = r, i = Array.isArray(n), a = 0, n = i ? n : (0, O.default)(n);
          ;
    ...
    function c(t, e, r) {
      return (
        (t.object = H.memberExpression(t.object, t.property, t.computed)),
        (t.property = e),
        (t.computed = !!r),
        t
      );
      ...
      for (var r in t)
        if ("_" !== r[0]) {
          ...
          n &&
            (n.type
              ? (n = H.cloneDeep(n))
              : Array.isArray(n) && (n = n.map(H.cloneDeep))),
            (e[r] = n);
        }
      return e;
    }
    ...
    (e.__esModule = !0),
      (e.createTypeAnnotationBasedOnTypeof =
        e.removeTypeDuplicates =
        e.createUnionTypeAnnotation =
        e.valueToNode =
        e.toBlock =
        e.toExpression =
        e.toStatement =
        e.toBindingIdentifierName =
        e.toIdentifier =
        e.toKeyAlias =
        e.toSequenceExpression =
        e.toComputedKey =
        e.isNodesEquivalent =
        e.isImmutable =
        e.isScope =
        e.isSpecifierDefault =
        e.isVar =
        e.isBlockScoped =
        e.isLet =
        e.isValidIdentifier =
        ...
        e.VISITOR_KEYS =
        e.NOT_LOCAL_BINDING =
        e.BLOCK_SCOPED_SYMBOL =
        e.INHERIT_KEYS =
        e.UNARY_OPERATORS =
        e.STRING_UNARY_OPERATORS =
        e.NUMBER_UNARY_OPERATORS =
        e.BOOLEAN_UNARY_OPERATORS =
        e.BINARY_OPERATORS =
        e.NUMBER_BINARY_OPERATORS =
        e.BOOLEAN_BINARY_OPERATORS =
        e.COMPARISON_BINARY_OPERATORS =
        e.EQUALITY_BINARY_OPERATORS =
        e.BOOLEAN_NUMBER_BINARY_OPERATORS =
        e.UPDATE_OPERATORS =
        e.LOGICAL_OPERATORS =
        e.COMMENT_KEYS =
        e.FOR_INIT_KEYS =
        e.FLATTENABLE_KEYS =
        e.STATEMENT_OR_BLOCK_KEYS =
          void 0);
    var T = r(152),
      S = n(T),
      P = r(15),
    ...
    (H.FLIPPED_ALIAS_KEYS = {}),
      (0, N.default)(H.ALIAS_KEYS).forEach(function (t) {
    ...
    e.TYPES = (0, N.default)(H.VISITOR_KEYS)
      .concat((0, N.default)(H.FLIPPED_ALIAS_KEYS))
      .concat((0, N.default)(H.DEPRECATED_KEYS));
    ...
    for (var Q in H.DEPRECATED_KEYS)
      !(function (t) {
        function e(e) {
          return function () {
            return (
              console.trace("The node type " + t + " has been renamed to " + r),
  ...
  function (t, e, r) {
    ...
    function c(t) {
      function e(e, r, n) {
        if (i(n) !== t)
          throw new TypeError(
            "Property " + r + " expected type of " + t + " but got " + i(n)
          );
      }
      return (e.type = t), e;
    }
    function l() {
      function t() {
        for (
          var t = r, e = Array.isArray(t), n = 0, t = e ? t : (0, h.default)(t);
          ;
    ...
    function p(t) {
      ...
      for (
        var n = e.visitor.concat(e.builder),
          a = Array.isArray(n),
          s = 0,
          n = a ? n : (0, h.default)(n);
        ;
      ...
      for (var l in e.fields) {
        var p = e.fields[l];
        -1 === e.builder.indexOf(l) && (p.optional = !0),
          void 0 === p.default
            ? (p.default = null)
            : p.validate || (p.validate = c(i(p.default)));
      }
      (E[t] = e.visitor),
        (g[t] = e.builder),
        (x[t] = e.fields),
  ...
  function (t, e, r) {
    ...
    function n(t) {
      ...
      return "[object String]" === e
        ...
        : "[object Boolean]" === e
        ? f.a
        : "[object Set]" === e || "[object Map]" === e
        ? h.a
        : "[object Promise]" === e
        ? d.a
        : t instanceof Error || "[object Error]" === e
        ? o.a
        : void 0 === t
        ? c.a
        : null === t
  ...
  function (t, e, r) {
    var n = r(4),
      ...
      o = function (t, e, r) {
        ...
        f && (r = e);
        for (u in r)
          ((c = !p && A && void 0 !== A[u]) && u in v) ||
            ((l = c ? A[u] : r[u]),
            (v[u] =
              f && "function" != typeof A[u]
                ? r[u]
                : y && c
                ? a(l, n)
                : m && A[u] == l
    ...
    var u = r(9),
      ...
      A = (function (t) {
        function e(t) {
          ...
          return (r.toggle = r.toggle.bind(r)), (r.state = { open: t.open }), r;
        }
        return (
          s(e, t),
          v(e, [
            {
              ...
              value: function (t, e) {
                return (
                  ...
                  (void 0 !== this.props.filter &&
                    this.props.filter !== t.filter)
                );
              },
            },
            {
            ...
            },
            {
              ...
              value: function () {
                ...
                if (
                  (v || (v = s.constructor ? s.constructor.name : "Object"),
                  !t && c)
                )
                  return l.default.createElement(
                    "div",
                    { onClick: this.toggle, className: "type " + y },
                  ...
                  t
                    ...
                    ? l.default.createElement(
                        ...
                        l.default.createElement(
                          ...
                          "{",
                          " ",
                          l.default.createElement(f.a, { value: s.message }),
                          " ",
                          "}"
                        )
                      )
                    ...
                    : ((A = m()(
                        d()(
                          A,
                          Array.from({ length: A.length - 1 }, function (t, e) {
                            return l.default.createElement(
                              "span",
                              { key: "sep-" + e, className: "sep" },
                              ","
                            );
                          })
                        )
  ...
  function (t, e, r) {
    ...
    e.default =
      "function" === typeof o.default && "symbol" === u(a.default)
        ? function (t) {
  ...
  function (t, e, r) {
    ...
    var n = r(4),
      ...
      J = function (t, e, r) {
        return (
          ...
          i(L, e)
            ? (r.enumerable
                ? (i(t, k) && t[k][e] && (t[k][e] = !1),
                  (r = g(r, { enumerable: x(0, !1) })))
                : (i(t, k) || S(t, k, x(1, {})), (t[k][e] = !0)),
              K(t, e, r))
            : S(t, e, r)
        );
      },
      G = function (t, e) {
        A(t);
        for (var r, n = v((e = E(e))), i = 0, a = n.length; a > i; )
          J(t, (r = n[i++]), e[r]);
        return t;
      },
      z = function (t, e) {
      ...
      H = function (t) {
        ...
        return (
          !(this === U && i(L, t) && !i(M, t)) &&
          (!(e || !i(this, t) || !i(L, t) || (i(this, k) && this[k][t])) || e)
        );
      },
      $ = function (t, e) {
        if (((t = E(t)), (e = D(e, !0)), t !== U || !i(L, e) || i(M, e))) {
          var r = T(t, e);
          return (
            !r || !i(L, e) || (i(t, k) && t[k][e]) || (r.enumerable = !0), r
          );
        }
      },
      Q = function (t) {
        for (var e, r = P(E(t)), n = [], a = 0; r.length > a; )
          i(L, (e = r[a++])) || e == k || e == u || n.push(e);
        return n;
      },
      Z = function (t) {
        for (
          var e, r = t === U, n = P(r ? M : E(t)), a = [], s = 0;
          n.length > s;

        )
          !i(L, (e = n[s++])) || (r && !i(U, e)) || a.push(L[e]);
        return a;
      };
    V ||
      ((O = function () {
        ...
        return a && q && K(U, t, { configurable: !0, set: e }), W(t);
      }),
      ...
      (r(46).f = H),
      (r(79).f = Z),
      a && !r(44) && o(U, "propertyIsEnumerable", H, !0),
      (d.f = function (t) {
        return W(h(t));
      })),
      s(s.G + s.W + s.F * !V, { Symbol: O });
    for (
      var tt =
  ...
  function (t, e, r) {
    ...
    var n = r(154),
      ...
      a =
        ((e.STATEMENT_OR_BLOCK_KEYS = ["consequent", "body", "alternate"]),
        (e.FLATTENABLE_KEYS = ["body", "expressions"]),
        (e.FOR_INIT_KEYS = ["left", "init"]),
        (e.COMMENT_KEYS = [
          "leadingComments",
          "trailingComments",
          "innerComments",
      ...
      l =
        ((e.BINARY_OPERATORS = ["+"].concat(c, u)),
        (e.BOOLEAN_UNARY_OPERATORS = ["delete", "!"])),
    ...
    (e.UNARY_OPERATORS = ["void"].concat(l, p, f)),
      ...
      (e.BLOCK_SCOPED_SYMBOL = (0, i.default)("var used to be block scoped")),
      (e.NOT_LOCAL_BINDING = (0, i.default)(
  ...
  function (t, e, r) {
    ...
    function s(t) {
      var e = "(async () => {" + t + "})()",
        ...
        u = {
          ClassDeclaration: function (t) {
            t.parent === i &&
              a.push({ text: t.id.name + "=", start: t.start, end: t.start });
          },
          FunctionDeclaration: function (t) {
            return (
              a.push({ text: t.id.name + "=", start: t.start, end: t.start }), t
            );
          },
          ...
          VariableDeclaration: function (t) {
            if ("var" === t.kind || t.parent === i) {
              ...
              try {
                for (
                  var o, u = t.declarations[Symbol.iterator]();
                  !(r = (o = u.next()).done);
                  r = !0
                ) {
                  var c = o.value;
                  c.init
                    ? (a.push({ text: "(", start: c.start, end: c.start }),
                      a.push({ text: ")", start: c.end, end: c.end }))
                    : (a.push({ text: "(", start: c.start, end: c.start }),
                      a.push({
                        text: "=undefined)",
                        start: c.end,
              ...
              if (!e) {
                ...
                a.push({ text: ")", start: l.end, end: l.end });
              }
            }
          },
        };
      ...
      var p = i.body[i.body.length - 1],
        f = null;
      if (void 0 === p) return { additionalCode: f, content: t };
      if (
        ("ExpressionStatement" === p.type &&
          (a.push({
          ...
          ";" !== e[p.end - 1]
            ? a.push({ text: ")", start: p.end, end: p.end })
            : a.push({ text: ")", start: p.end - 1, end: p.end - 1 })),
        "VariableDeclaration" !== p.type ||
          ("const" !== p.kind && "let" !== p.kind) ||
          ((f = p.kind + " " + p.declarations[0].id.name + " = $_"),
          a.push({
        ...
        if (f) {
          t =
            t.substr(0, p.declarations[0].id.end - 14) +
            " = window.$_" +
            t.substr(p.declarations[0].id.end - 14);
        }
        return { content: t, additionalCode: f };
      }
      for (; a.length; ) {
        var h = a.pop();
        e = e.substr(0, h.start) + h.text + e.substr(h.end);
      }
      return { content: e, additionalCode: f };
    }
    r.d(e, "c", function () {
      return d;
    }),
                                  ...
                                  for (;;)
                                    switch ((t.prev = t.next)) {
                                      case 0:
                                        ...
                                        return (
                                          (t.next = 7), h.contentWindow.eval(o)
                                        );
                                      case 7:
  ...
  function (t, e, r) {
    t.exports = { default: r(161), __esModule: !0 };
  },
  function (t, e, r) {
    var n = r(25),
      i = r(4).document,
  ...
  function (t, e, r) {
    ...
    t.exports = function (t, e, r, y, m, v, b) {
      ...
      if (
        (P &&
          (D = p(P.call(new t()))) !== Object.prototype &&
          (l(D, g, !0), n || o(D, f) || s(D, f, d)),
        C &&
          _ &&
          "values" !== _.name &&
          ((w = !0),
      ...
      for (var n = [].concat(t), i = (0, s.default)(null); n.length; ) {
        ...
        if (a) {
          ...
          if (u.isIdentifier(a))
            ...
            u.isDeclaration(a.declaration) && n.push(a.declaration);
          else {
            if (r) {
  ...
  function (t, e) {
    !(function () {
      ...
      function r(t) {
        return (
          (48 <= t && t <= 57) || (97 <= t && t <= 102) || (65 <= t && t <= 70)
        );
      }
      function n(t) {
        return t >= 48 && t <= 55;
      ...
      for (
        ...
        d[m] =
          (m >= 97 && m <= 122) || (m >= 65 && m <= 90) || 36 === m || 95 === m;
      for (y = new Array(128), m = 0; m < 128; ++m)
        y[m] =
          (m >= 97 && m <= 122) ||
          (m >= 65 && m <= 90) ||
          (m >= 48 && m <= 57) ||
  ...
  function (t, e, r) {
    ...
    function l(t, e) {
      m(function () {
        ...
        if (null === r)
          return void (1 === t._81 ? p(e.promise, t._65) : f(e.promise, t._65));
        var n = a(r, t._65);
    ...
    function p(t, e) {
      ...
      if (e && ("object" === typeof e || "function" === typeof e)) {
        ...
        if (r === t.then && e instanceof o)
          return (t._81 = 3), (t._65 = e), void h(t);
      ...
      var r = {
        run: function (n) {
          try {
            ...
            (i !== r.props || r.error) &&
              ((r.shouldComponentUpdate = !0), (r.props = i), (r.error = null));
          } catch (t) {
          ...
          f = (function (s) {
            ...
            return (
              ...
              (p.prototype.addExtraProps = function (t) {
                if (!P && !C && (!this.propsMode || !this.subscription))
                  return t;
                var e = v({}, t);
                return (
  ...
  function (t, e, r) {
    ...
    function n(t, e, a) {
      ...
      return (
        p({ type: o.INIT }),
        (d = { dispatch: p, subscribe: l, getState: c, replaceReducer: f }),
        (d[s.a] = h),
        d
      );
    }
  ...
  function (t, e, r) {
    ...
    "undefined" === typeof Promise &&
      (r(332).enable(), (window.Promise = r(331))),
      r(356),
      (Object.assign = r(328));
  },
  function (t, e, r) {
      ...
      p = function () {
        ...
        i.default.render(
          n.default.createElement(
            a.a,
            { store: s.a },
            n.default.createElement(t, null)
          ),
          l
        );
      };
  ...
  function (t, e, r) {
                        ...
                        for (;;)
                          switch ((t.prev = t.next)) {
                            ...
                            case 13:
                              return (
                                (t.next = 15),
                                b.a[u]({ args: l, console: i, app: this })
                              );
                            case 15:
                              return (
                                (p = t.sent),
                                "string" === typeof p && (p = { value: p }),
                                void 0 !== p &&
                                  i.push(
                                    Object.assign(
                                      { command: e, type: "log" },
    ...
    (D.contextTypes = { store: f.a.object }), (e.a = D);
  },
  function (t, e, r) {
    "use strict";
    function n(t, e, r) {
    ...
    function l() {
      ...
      return (
        "string" === typeof a &&
          a.includes("%") &&
          s.length &&
          ((a = a.replace(/(%[scdif]|%(\d*)\.(\d*)[dif])/g, function (t, e) {
            var r =
            ...
            if ("%c" === e)
              return (c = !0), '</span><span style="' + s.shift() + '">';
            var i = s.shift(),
              a = null;
            return (
              (a =
        ...
        return (
          (r.error = function () {
            var t = l.apply(void 0, arguments),
              e = t.html,
              n = t.args;
            r.push({ error: !0, html: e, value: n, type: "log" });
          }),
          (r.dir = function () {
            var t = l.apply(void 0, arguments),
              e = t.html,
              n = t.args;
            r.push({ value: n, html: e, open: !0, type: "log" });
          }),
          (r.debug = function () {
            ...
            value: function (t) {
              ...
              if (!t) {
                ...
                void 0 === i && (i = "console.assert"),
                  r.unshift(new c(i)),
                  this.push({ error: !0, value: r, type: "log" });
              }
            },
          },
          {
          ...
          },
          {
            ...
            value: function () {
              var t = l.apply(void 0, arguments),
                e = t.html,
                r = t.args;
              this.push({ value: r, html: e, type: "log" });
            },
          },
          {
            key: "render",
          ...
          c(e, [
            {
              ...
              value: function (t) {
                this.props.enabled !== t.enabled &&
                  (this.props.enabled
                    ? this.input.focus()
                    : ((this.input.value = ""), this.props.onFilter(null)));
              },
            },
            {
              key: "render",
                        ...
                        for (;;)
                          switch ((t.prev = t.next)) {
                            case 0:
                              if (
                                ((r = l.a[e.keyCode]),
                                (n = this.state.multiline),
                                (i = this.props.history),
                                (a = this.state.historyCursor),
                                !e.ctrlKey || "l" !== r)
                              ) {
                                t.next = 7;
                                break;
                ...
                if (
                  ("command" === i &&
                    (A = s.default.createElement(
                      ...
                      s.default.createElement(o.a, { value: a }),
                      a
                    )),
                  "log" === i || "response" === i)
                ) {
                  if ("log" === i && Array.isArray(a) && 0 === a.length)
                    return null;
                  A = s.default.createElement(
                    "div",
                    {
                      className:
                        "prompt output " + i + " " + (f ? "error" : ""),
                    },
                    s.default.createElement(o.a, {
                      ...
                      value:
                        "log" === i && Array.isArray(a) && 1 === a.length
                          ? a[0]
                          : a,
                      command: l,
                    }),
                    ("log" === i && Array.isArray(a) ? a : [a]).map(function (
                      t,
                      e
                    ) {
                      var n = r.i(u.a)(t);
                          ...
                          switch ((t.prev = t.next)) {
                            case 0:
                              if (
                                ...
                                (n = r.value),
                                (i = r.type),
                                !this.state.copyAsHTML)
                              ) {
                                t.next = 5;
                                break;
                              }
                              return (
                                this.setState({ text: n.outerHTML }),
                                t.abrupt("return")
                              );
                            case 5:
                            ...
                            case 8:
                              ...
                              return (
                                this.setState({ text: n }), t.abrupt("return")
                              );
                            case 11:
                              if ("[object Promise]" !== i) {
                                t.next = 17;
                            ...
                            case 17:
                              (n instanceof Error || "[object Error]" === i) &&
                                ((n = Object.getOwnPropertyNames(n).reduce(
                                  function (t, e) {
                                    return (t[e] = n[e]), t;
                                  },
                                  {}
            ...
            },
            {
              ...
              value: function () {
                ...
                return c.default.createElement(
                  ...
                  { className: "LineNav" },
                  "object" ===
                    ("undefined" === typeof n ? "undefined" : h(n)) &&
              ...
              value: function () {
                ...
                if (i && !c)
                  return s.default.createElement(
                    ...
                    s.default.createElement("em", null, "Array"),
                    s.default.createElement(
                      "span",
                      { className: "arb-info" },
                      "(",
                ...
                if (!c) {
                  ...
                  0 !== d &&
                    y.push(
                      s.default.createElement(
                        "span",
                        { key: "hole-" + h.length, className: "arb-info" },
                        "<undefined \xd7 ",
                        d,
                        ">"
                      )
                ...
                return (
                  ...
                  c
                    ...
                    : ((h = l()(
                        u()(
                          h,
                          Array.from({ length: h.length - 1 }, function (t, e) {
                            return s.default.createElement(
                              "span",
                              { key: "sep-" + e, className: "sep" },
                              ","
                  ...
                  : s.default.createElement(
                      ...
                      s.default.createElement(
                        ...
                        s.default.createElement(
                          "span",
                          { className: "key" },
                          s.default.createElement(c, { allowOpen: e, value: i })
                        ),
                        s.default.createElement(
                          "span",
                          { className: "arb-info" },
                        ...
                        s.default.createElement(
                          "span",
                          { className: "value" },
                          s.default.createElement(l, { allowOpen: e, value: a })
                        )
                      )
                    );
              },
                          ...
                          switch ((t.prev = t.next)) {
                            ...
                            case 2:
                              (e = t.sent),
                                (r = e.promiseValue),
                                (n = e.status),
                                this.setState({ promiseValue: r, status: n });
                            case 6:
                            case "end":
                              return t.stop();
                          }
                ...
                return n
                  ? c.default.createElement(
                      ...
                      c.default.createElement(
                        "div",
                        { className: "header" },
                        c.default.createElement("em", null, "Promise"),
              ...
              value: function () {
                ...
                if (n && !i)
                  return s.default.createElement(
                    ...
                    s.default.createElement("em", null, a),
                    s.default.createElement(
                      "span",
                      { className: "arb-info" },
                      "(",
                ...
                try {
                  for (
                    var m, v = e.entries()[Symbol.iterator]();
                    !(h = (m = v.next()).done);
                    h = !0
                  ) {
                    var b = m.value;
                ...
                return (
                  ...
                  i
                    ? s.default.createElement(
                        ...
                        s.default.createElement(
                          ...
                          l.map(function (t, e) {
                            return s.default.createElement(
                              "div",
                              { className: "key-value", key: "subtype-" + e },
                              s.default.createElement(
                                "span",
                                { className: "index" },
                                e,
                    ...
                    : ((l = p()(
                        c()(
                          l,
                          Array.from({ length: u - 1 }, function (t, e) {
                            return s.default.createElement(
                              "span",
                              { key: "sep-" + e, className: "sep" },
                              ","
  ...
  function (t, e, r) {
    ...
    e.default = r.i(n.b)(
      function (t) {
        var e = t.settings;
        return { theme: e.theme, layout: e.layout };
      },
      { setTheme: a.c, setLayout: a.d }
    )(i.a);
  },
  function (t, e, r) {
    "use strict";
  ...
  function (t, e, r) {
    ...
    var a = r(9),
      ...
      p = function () {
        return {
          value:
            "Use <strong>:help</strong> to show jsconsole commands\nversion: 2.1.2",
          html: !0,
        };
      },
      f = function () {
      ...
      d = {
        ...
        underscore:
          "https://cdn.jsdelivr.net/underscorejs/latest/underscore-min.js",
        lodash: "https://cdn.jsdelivr.net/lodash/latest/lodash.min.js",
        moment: "https://cdn.jsdelivr.net/momentjs/latest/moment.min.js",
        datefns:
          "https://cdn.jsdelivr.net/gh/date-fns/date-fns/dist/date_fns.min.js",
      },
      y = (function () {
        var t = i(
                ...
                for (;;)
                  switch ((t.prev = t.next)) {
                    case 0:
                      (t.t0 = n),
                        (t.next =
                          "theme" === t.t0 ? 3 : "layout" === t.t0 ? 5 : 7);
                      break;
                    case 3:
                      return (
                        ["light", "dark"].includes(i) && a.props.setTheme(i),
                        t.abrupt("break", 7)
                      );
                    case 5:
                      return (
                        ["top", "bottom"].includes(i) && a.props.setLayout(i),
                        t.abrupt("break", 7)
                      );
                    case 7:
                    case "end":
              ...
              function (t) {
                for (;;)
                  switch ((t.prev = t.next)) {
                    case 0:
                      if (
                        ((r = i.context.store.getState().history), null !== l)
                      ) {
                        t.next = 3;
                        break;
                      }
    ...
    var i = [],
      a = function () {
        var t =
          ...
          e = arguments[1];
        return "ADD_HISTORY" === e.type && t.slice(-1).pop() !== e.value
          ? [].concat(n(t), [e.value])
          : t;
      };
    e.a = a;
  ...
  function (t, e, r) {
    ...
    var n = r(70),
      i = r(145),
      a = r(147);
    e.a = r.i(n.d)({ history: i.a, settings: a.a });
  },
  function (t, e, r) {
    "use strict";
    var n = r(37),
      i = { theme: "light", layout: "bottom", remote: !1 },
      a = function () {
        var t =
            arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : i,
          e = arguments[1];
        return e.type === n.a
          ? Object.assign({}, t, { theme: e.value })
          : e.type === n.b
          ? Object.assign({}, t, { layout: e.value })
          : t;
      };
    e.a = a;
  },
  function (t, e, r) {
          ...
          return function (e) {
            return function (r) {
              var n = e(r),
                i = t.getState();
              return (
                (r.type !== a.a && r.type !== a.b) ||
                  o("settings", i.settings, "local"),
    ...
    window.__REDUX_DEVTOOLS_EXTENSION__ &&
      u.push(window.__REDUX_DEVTOOLS_EXTENSION__());
    var c = i.b.apply(void 0, u)(i.c),
      l = {};
    try {
      (l.settings = JSON.parse(
        localStorage.getItem("jsconsole.settings") || "{}"
      )),
        (l.history = JSON.parse(
  ...
  function (t, e, r) {
    t.exports = { default: r(158), __esModule: !0 };
  },
  function (t, e, r) {
    t.exports = { default: r(159), __esModule: !0 };
  },
  function (t, e, r) {
    t.exports = { default: r(160), __esModule: !0 };
  },
  function (t, e, r) {
    t.exports = { default: r(163), __esModule: !0 };
  },
  function (t, e, r) {
    t.exports = { default: r(162), __esModule: !0 };
  },
  function (t, e, r) {
    t.exports = { default: r(164), __esModule: !0 };
  },
  function (t, e, r) {
  ...
  function (t, e, r) {
    ...
    t.exports = function (t) {
      var e = n(t),
        r = i.f;
      if (r)
        for (var s, o = r(t), u = a.f, c = 0; o.length > c; )
          u.call(t, (s = o[c++])) && e.push(s);
      return e;
    };
  },
  function (t, e, r) {
  ...
  function (t, e, r) {
    ...
    r(17)(s, r(5)("iterator"), function () {
      ...
      (t.exports = function (t, e, r) {
        (t.prototype = n(s, { next: i(1, r) })), a(t, e + " Iterator");
      });
  },
  function (t, e) {
    t.exports = function (t, e) {
  ...
  function (t, e, r) {
    ...
    t.exports = r(16)
      ...
      : function (t, e) {
          i(t);
          for (var r, s = a(e), o = s.length, u = 0; o > u; )
            n.f(t, (r = s[u++]), e[r]);
          return t;
        };
  },
  ...
  function (t, e, r) {
    ...
    function i(t) {
      var e =
        arguments.length > 1 && void 0 !== arguments[1]
          ...
          : t.key || t.property;
      return (
        t.computed || (C.isIdentifier(e) && (e = C.stringLiteral(e.name))), e
      );
    }
    function a(t, e) {
      function r(t) {
          ...
          if (C.isExpression(p)) s.push(p);
            ...
            if (C.isVariableDeclaration(p)) {
              ...
              for (
                ...
                for (var A in v) n.push({ kind: p.kind, id: v[A] });
        ...
        return (
          (a || 0 === s.length) && s.push(e.buildUndefinedNode()),
    ...
    function s(t) {
      ...
      return "method" === t.kind
        ...
        : ((r = C.isIdentifier(e)
            ...
            : C.isStringLiteral(e)
            ? (0, m.default)(e.value)
            : (0, m.default)(C.removePropertiesDeep(C.cloneDeep(e)))),
          t.computed && (r = "[" + r + "]"),
          t.static && (r = "static:" + r),
          r);
    }
    ...
    function u(t) {
      return (
        (t = o(t)), ("eval" !== t && "arguments" !== t) || (t = "_" + t), t
      );
    }
    function c(t, e) {
    ...
    function l(t) {
      if ((C.isExpressionStatement(t) && (t = t.expression), C.isExpression(t)))
        return t;
      if (
        (C.isClass(t)
          ? (t.type = "ClassExpression")
          : C.isFunction(t) && (t.type = "FunctionExpression"),
        !C.isExpression(t))
      )
    ...
    function p(t, e) {
      return C.isBlockStatement(t)
        ? t
        : (C.isEmptyStatement(t) && (t = []),
          Array.isArray(t) ||
            (C.isStatement(t) ||
              (t = C.isFunction(e)
                ? C.returnStatement(t)
  ...
  function (t, e, r) {
    ...
    (0, o.default)("ArrayExpression", {
      ...
      (0, o.default)("AssignmentExpression", {
        fields: {
          operator: { validate: (0, s.assertValueType)("string") },
          left: { validate: (0, s.assertNodeType)("LVal") },
      ...
      (0, o.default)("Directive", {
        visitor: ["value"],
        fields: {
          value: { validate: (0, s.assertNodeType)("DirectiveLiteral") },
        },
      }),
      ...
      (0, o.default)("CatchClause", {
        visitor: ["param", "body"],
        fields: {
          param: { validate: (0, s.assertNodeType)("Identifier") },
      ...
      (0, o.default)("ConditionalExpression", {
        ...
        fields: {
          ...
          consequent: { validate: (0, s.assertNodeType)("Expression") },
          alternate: { validate: (0, s.assertNodeType)("Expression") },
        },
      ...
      (0, o.default)("File", {
        ...
        visitor: ["program"],
        fields: { program: { validate: (0, s.assertNodeType)("Program") } },
      }),
      ...
      (0, o.default)("ForStatement", {
        ...
        fields: {
          ...
          test: { validate: (0, s.assertNodeType)("Expression"), optional: !0 },
          update: {
      ...
      (0, o.default)("FunctionDeclaration", {
        ...
        fields: {
          id: { validate: (0, s.assertNodeType)("Identifier") },
          params: {
            validate: (0, s.chain)(
              (0, s.assertValueType)("array"),
              (0, s.assertEach)((0, s.assertNodeType)("LVal"))
            ),
          },
          body: { validate: (0, s.assertNodeType)("BlockStatement") },
          generator: {
          ...
          async: { default: !1, validate: (0, s.assertValueType)("boolean") },
        },
        aliases: [
          "Scopable",
          "Function",
      ...
      (0, o.default)("FunctionExpression", {
        ...
        fields: {
          id: { validate: (0, s.assertNodeType)("Identifier"), optional: !0 },
          params: {
            validate: (0, s.chain)(
              (0, s.assertValueType)("array"),
              (0, s.assertEach)((0, s.assertNodeType)("LVal"))
      ...
      (0, o.default)("IfStatement", {
        ...
        fields: {
          test: { validate: (0, s.assertNodeType)("Expression") },
          consequent: { validate: (0, s.assertNodeType)("Statement") },
          alternate: {
            optional: !0,
      ...
      (0, o.default)("NumericLiteral", {
        ...
        fields: { value: { validate: (0, s.assertValueType)("number") } },
        aliases: ["Expression", "Pureish", "Literal", "Immutable"],
      }),
      ...
      (0, o.default)("BooleanLiteral", {
        builder: ["value"],
        fields: { value: { validate: (0, s.assertValueType)("boolean") } },
        aliases: ["Expression", "Pureish", "Literal", "Immutable"],
      }),
      (0, o.default)("RegExpLiteral", {
        ...
        fields: {
          ...
          flags: { validate: (0, s.assertValueType)("string"), default: "" },
        },
      }),
        ...
        fields: {
          kind: {
            validate: (0, s.chain)(
              ...
              (0, s.assertOneOf)("method", "get", "set")
            ),
            default: "method",
          },
          computed: {
      ...
      (0, o.default)("RestElement", {
        ...
        aliases: ["LVal"],
        fields: {
          argument: { validate: (0, s.assertNodeType)("LVal") },
          decorators: {
            validate: (0, s.chain)(
              (0, s.assertValueType)("array"),
              (0, s.assertEach)((0, s.assertNodeType)("Decorator"))
      ...
      (0, o.default)("SwitchStatement", {
        ...
        fields: {
          discriminant: { validate: (0, s.assertNodeType)("Expression") },
          cases: {
            validate: (0, s.chain)(
              (0, s.assertValueType)("array"),
      ...
      (0, o.default)("UnaryExpression", {
        ...
        fields: {
          prefix: { default: !0 },
          argument: { validate: (0, s.assertNodeType)("Expression") },
          operator: {
      ...
      (0, o.default)("VariableDeclaration", {
        ...
        fields: {
          kind: {
            validate: (0, s.chain)(
              (0, s.assertValueType)("string"),
              (0, s.assertOneOf)("var", "let", "const")
            ),
          },
          declarations: {
            validate: (0, s.chain)(
              (0, s.assertValueType)("array"),
              (0, s.assertEach)((0, s.assertNodeType)("VariableDeclarator"))
            ),
          },
        },
      }),
      (0, o.default)("VariableDeclarator", {
        visitor: ["id", "init"],
        fields: {
          id: { validate: (0, s.assertNodeType)("LVal") },
          init: { optional: !0, validate: (0, s.assertNodeType)("Expression") },
        },
      }),
      ...
      (0, o.default)("WithStatement", {
        ...
        aliases: ["Statement"],
        fields: {
          object: { object: (0, s.assertNodeType)("Expression") },
          body: {
            validate: (0, s.assertNodeType)("BlockStatement", "Statement"),
          },
        },
    ...
    (0, i.default)("AssignmentPattern", {
        ...
        fields: {
          elements: {
            validate: (0, n.chain)(
              (0, n.assertValueType)("array"),
              (0, n.assertEach)(
                (0, n.assertNodeType)("Identifier", "Pattern", "RestElement")
              )
            ),
          },
          decorators: {
      ...
      (0, i.default)("ArrowFunctionExpression", {
        ...
        fields: {
          ...
          async: { validate: (0, n.assertValueType)("boolean"), default: !1 },
        },
      }),
      ...
      (0, i.default)("ClassExpression", {
        ...
        fields: {
          id: { optional: !0, validate: (0, n.assertNodeType)("Identifier") },
          body: { validate: (0, n.assertNodeType)("ClassBody") },
          superClass: {
            optional: !0,
            validate: (0, n.assertNodeType)("Expression"),
      ...
      (0, i.default)("ImportDefaultSpecifier", {
        visitor: ["local"],
        aliases: ["ModuleSpecifier"],
        fields: { local: { validate: (0, n.assertNodeType)("Identifier") } },
      }),
      ...
      (0, i.default)("ImportSpecifier", {
        ...
        fields: {
          ...
          importKind: { validate: (0, n.assertOneOf)(null, "type", "typeof") },
        },
      }),
      ...
      (0, i.default)("ClassMethod", {
        ...
        fields: {
          ...
          static: { default: !1, validate: (0, n.assertValueType)("boolean") },
          key: {
            validate: function (t, e, r) {
              var i = t.computed
                ? ["Expression"]
          ...
          async: { default: !1, validate: (0, n.assertValueType)("boolean") },
        },
      }),
      ...
      (0, i.default)("SpreadElement", {
        visitor: ["argument"],
        aliases: ["UnaryLike"],
        fields: { argument: { validate: (0, n.assertNodeType)("Expression") } },
      }),
      ...
      (0, i.default)("TemplateElement", {
        ...
        fields: {
          value: {},
          tail: { validate: (0, n.assertValueType)("boolean"), default: !1 },
        },
      }),
  ...
  function (t, e, r) {
    ...
    (0, i.default)("AwaitExpression", {
      ...
      (0, i.default)("DoExpression", {
        visitor: ["body"],
        aliases: ["Expression"],
        fields: { body: { validate: (0, n.assertNodeType)("BlockStatement") } },
      }),
      (0, i.default)("ExportDefaultSpecifier", {
        visitor: ["exported"],
        aliases: ["ModuleSpecifier"],
        fields: { exported: { validate: (0, n.assertNodeType)("Identifier") } },
      }),
  ...
  function (t, e, r) {
    ...
    (0, i.default)("AnyTypeAnnotation", {
      ...
      (0, i.default)("ExistentialTypeParam", { aliases: ["Flow"] }),
  ...
  function (t, e, r) {
    ...
    (0, i.default)("JSXAttribute", {
      ...
      (0, i.default)("JSXEmptyExpression", { aliases: ["JSX", "Expression"] }),
      ...
      for (var e = {}, r = {}, n = [], a = [], s = 0; s < t.length; s++) {
        ...
        if (u && !(a.indexOf(u) >= 0)) {
          ...
          if (o.isFlowBaseAnnotation(u)) r[u.type] = u;
            ...
            n.indexOf(u.types) < 0 &&
              ((t = t.concat(u.types)), n.push(u.types));
            ...
            if (e[c]) {
              ...
              l.typeParameters
                ? u.typeParameters &&
                  (l.typeParameters.params = i(
                    l.typeParameters.params.concat(u.typeParameters.params)
                  ))
                : (l = u.typeParameters);
            } else e[c] = u;
          } else a.push(u);
  ...
  function (t, e, r) {
    ...
    function a(t) {
      for (var e = [], r = 0; r < t.children.length; r++) {
        ...
        o.isJSXText(n)
          ? i(n, e)
          : (o.isJSXExpressionContainer(n) && (n = n.expression),
            o.isJSXEmptyExpression(n) || e.push(n));
      }
      return e;
    }
    (e.__esModule = !0),
  ...
  function (t, e, r) {
    ...
    function s(t) {
      return (
        "string" === typeof t &&
        !x.default.keyword.isReservedWordES6(t, !0) &&
        "await" !== t &&
        x.default.keyword.isIdentifierNameES6(t)
      );
    }
    function o(t) {
      return (
        C.isVariableDeclaration(t) &&
        ("var" !== t.kind || t[w.BLOCK_SCOPED_SYMBOL])
      );
    }
    function u(t) {
      return (
        C.isFunctionDeclaration(t) || C.isClassDeclaration(t) || C.isLet(t)
      );
    }
    function c(t) {
      return (
        C.isVariableDeclaration(t, { kind: "var" }) && !t[w.BLOCK_SCOPED_SYMBOL]
      );
    }
    function l(t) {
      return (
        C.isImportDefaultSpecifier(t) ||
        C.isIdentifier(t.imported || t.exported, { name: "default" })
      );
    }
    function p(t, e) {
      return (
        (!C.isBlockStatement(t) || !C.isFunction(e, { body: t })) &&
        C.isScopable(t)
      );
    }
    function f(t) {
      return (
        !!C.isType(t.type, "Immutable") ||
        (!!C.isIdentifier(t) && "undefined" === t.name)
      );
    }
    function h(t, e) {
      if (
        "object" !==
          ("undefined" === typeof t ? "undefined" : (0, v.default)(t)) ||
        "object" !==
          ("undefined" === typeof t ? "undefined" : (0, v.default)(t)) ||
        null == t ||
        null == e
      ...
      for (
        var r = (0, y.default)(C.NODE_FIELDS[t.type] || t.type),
          n = r,
          i = Array.isArray(n),
          a = 0,
          n = i ? n : (0, A.default)(n);
      ...
      for (var y in t)
        if (!c(y)) {
          ...
          if (
            (E &&
              (console.trace(
                "Visitor defined for " + y + " but it has been renamed to " + E
              ),
              (A = [E])),
            A)
          ) {
      ...
      if (!t._verified) {
        ...
        for (var e in t)
          if ((("enter" !== e && "exit" !== e) || s(e, t[e]), !c(e))) {
            ...
            if (
              "object" ===
              ("undefined" === typeof r ? "undefined" : (0, f.default)(r))
            )
              for (var n in r) {
                if ("enter" !== n && "exit" !== n)
                  throw new Error(
  ...
  function (t, e, r) {
    ...
    function p(t, e, r, n) {
      return (
        (t.type = e), (t.end = r), (t.loc.end = n), this.processComment(t), t
      );
    }
    function f(t) {
      return t[t.length - 1];
    ...
    var g = [
      ...
      N = (function (t) {
        function e(r, n) {
          return (
            _(this, e), S(this, t.call(this, r, { beforeExpr: P, binop: n }))
          );
        }
        return T(e, t), e;
      })(O),
      k = {
        num: new O("num", { startsExpr: !0 }),
        regexp: new O("regexp", { startsExpr: !0 }),
        string: new O("string", { startsExpr: !0 }),
        name: new O("name", { startsExpr: !0 }),
        eof: new O("eof"),
        bracketL: new O("[", { beforeExpr: P, startsExpr: !0 }),
        bracketR: new O("]"),
        braceL: new O("{", { beforeExpr: P, startsExpr: !0 }),
        braceBarL: new O("{|", { beforeExpr: P, startsExpr: !0 }),
        braceR: new O("}"),
        braceBarR: new O("|}"),
        parenL: new O("(", { beforeExpr: P, startsExpr: !0 }),
        parenR: new O(")"),
        comma: new O(",", { beforeExpr: P }),
        semi: new O(";", { beforeExpr: P }),
        colon: new O(":", { beforeExpr: P }),
        doubleColon: new O("::", { beforeExpr: P }),
        dot: new O("."),
        question: new O("?", { beforeExpr: P }),
        arrow: new O("=>", { beforeExpr: P }),
        template: new O("template"),
        ellipsis: new O("...", { beforeExpr: P }),
        backQuote: new O("`", { startsExpr: !0 }),
        dollarBraceL: new O("${", { beforeExpr: P, startsExpr: !0 }),
        at: new O("@"),
        eq: new O("=", { beforeExpr: P, isAssign: !0 }),
        assign: new O("_=", { beforeExpr: P, isAssign: !0 }),
        incDec: new O("++/--", { prefix: !0, postfix: !0, startsExpr: !0 }),
        prefix: new O("prefix", { beforeExpr: P, prefix: !0, startsExpr: !0 }),
        logicalOR: new N("||", 1),
        logicalAND: new N("&&", 2),
        bitwiseOR: new N("|", 3),
        bitwiseXOR: new N("^", 4),
      ...
      j = {
        break: new B("break"),
        case: new B("case", { beforeExpr: P }),
        catch: new B("catch"),
        continue: new B("continue"),
        debugger: new B("debugger"),
        default: new B("default", { beforeExpr: P }),
        do: new B("do", { isLoop: !0, beforeExpr: P }),
        else: new B("else", { beforeExpr: P }),
        finally: new B("finally"),
        for: new B("for", { isLoop: !0 }),
        function: new B("function", { startsExpr: !0 }),
        if: new B("if"),
        return: new B("return", { beforeExpr: P }),
        switch: new B("switch"),
        throw: new B("throw", { beforeExpr: P }),
        try: new B("try"),
        var: new B("var"),
        let: new B("let"),
        const: new B("const"),
        while: new B("while", { isLoop: !0 }),
        with: new B("with"),
        new: new B("new", { beforeExpr: P, startsExpr: !0 }),
        this: new B("this", { startsExpr: !0 }),
        super: new B("super", { startsExpr: !0 }),
        class: new B("class"),
        extends: new B("extends", { beforeExpr: P }),
        export: new B("export"),
        import: new B("import", { startsExpr: !0 }),
        yield: new B("yield", { beforeExpr: P, startsExpr: !0 }),
        null: new B("null", { startsExpr: !0 }),
        true: new B("true", { startsExpr: !0 }),
        false: new B("false", { startsExpr: !0 }),
        in: new B("in", { beforeExpr: P, binop: 7 }),
        instanceof: new B("instanceof", { beforeExpr: P, binop: 7 }),
        typeof: new B("typeof", { beforeExpr: P, prefix: !0, startsExpr: !0 }),
        void: new B("void", { beforeExpr: P, prefix: !0, startsExpr: !0 }),
        delete: new B("delete", { beforeExpr: P, prefix: !0, startsExpr: !0 }),
      };
    ...
    (k.parenR.updateContext = k.braceR.updateContext =
      ...
      (k.name.updateContext = function (t) {
        (this.state.exprAllowed = !1),
          (t !== k._let && t !== k._const && t !== k._var) ||
            (I.test(this.input.slice(this.state.end)) &&
              (this.state.exprAllowed = !0));
      }),
      ...
      (k.backQuote.updateContext = function () {
        this.curContext() === U.template
          ...
          : this.state.context.push(U.template),
          (this.state.exprAllowed = !1);
      });
      ...
      W = (function () {
        ...
        return (
          ...
          (t.prototype.setStrict = function (t) {
            if (
              ((this.state.strict = t),
              this.match(k.num) || this.match(k.string))
            ) {
              for (
          ...
          (t.prototype.skipBlockComment = function () {
            ...
            for (
              var n = void 0;
              (n = R.exec(this.input)) && n.index < this.state.pos;
          ...
          (t.prototype.skipLineComment = function (t) {
            for (
              var e = this.state.pos,
                ...
                n = this.input.charCodeAt((this.state.pos += t));
              this.state.pos < this.input.length &&
              10 !== n &&
              13 !== n &&
              8232 !== n &&
          ...
          (t.prototype.readToken_dot = function () {
            ...
            return 46 === t && 46 === e
              ? ((this.state.pos += 3), this.finishToken(k.ellipsis))
              : (++this.state.pos, this.finishToken(k.dot));
          }),
          ...
          (t.prototype.readToken_plus_min = function (t) {
            ...
            return e === t
              ? 45 === e &&
                ...
                I.test(this.input.slice(this.state.lastTokEnd, this.state.pos))
            ...
            return e === t
              ? ((r =
                ...
                61 === this.input.charCodeAt(this.state.pos + r)
                  ? this.finishOp(k.assign, r + 1)
                  : this.finishOp(k.bitShift, r))
              : 33 === e &&
                60 === t &&
              ...
              ? (this.inModule && this.unexpected(),
                ...
                this.skipSpace(),
                this.nextToken())
              : (61 === e && (r = 2), this.finishOp(k.relational, r));
          }),
          (t.prototype.readToken_eq_excl = function (t) {
            ...
            return 61 === e
              ...
              : 61 === t && 62 === e
              ? ((this.state.pos += 2), this.finishToken(k.arrow))
            ...
            switch (t) {
              ...
              case 123:
                return this.hasPlugin("flow") &&
                  ...
                  ? this.finishOp(k.braceBarL, 2)
                  : (++this.state.pos, this.finishToken(k.braceL));
              case 125:
              ...
              case 58:
                return this.hasPlugin("functionBind") &&
                  ...
                  ? this.finishOp(k.doubleColon, 2)
                  : (++this.state.pos, this.finishToken(k.colon));
              case 63:
          ...
          (t.prototype.readRegexp = function () {
            for (var t = this.state.pos, e = void 0, r = void 0; ; ) {
              ...
              if (
                (I.test(n) && this.raise(t, "Unterminated regular expression"),
                e)
              )
                e = !1;
              else {
            ...
            return this.finishToken(k.regexp, { pattern: i, flags: a });
          }),
          (t.prototype.readInt = function (t, e) {
            for (
              var r = this.state.pos, n = 0, i = 0, a = null == e ? 1 / 0 : e;
              i < a;
              ++i
            ) {
            ...
            return (
              n
                ...
                ? this.state.strict
                  ...
                  : (o = /[89]/.test(s) ? parseInt(s, 10) : parseInt(s, 8))
                : (o = parseInt(s, 10)),
          ...
          (t.prototype.readCodePoint = function (t) {
            ...
            if (123 === e) {
              ...
              if (
                ...
                if (!t)
                  return (
                    (this.state.invalidTemplateEscapePosition = n - 2), null
                  );
          ...
          (t.prototype.readTmplToken = function () {
            for (var t = "", e = this.state.pos, r = !1; ; ) {
              ...
              if (
                96 === n ||
                (36 === n && 123 === this.input.charCodeAt(this.state.pos + 1))
              )
                return this.state.pos === this.state.start &&
                  this.match(k.template)
                  ? 36 === n
                    ? ((this.state.pos += 2), this.finishToken(k.dollarBraceL))
                    : (++this.state.pos, this.finishToken(k.backQuote))
                  : ((t += this.input.slice(e, this.state.pos)),
                    this.finishToken(k.template, r ? null : t));
              if (92 === n) {
                t += this.input.slice(e, this.state.pos);
            ...
            switch ((++this.state.pos, r)) {
              ...
              default:
                if (r >= 48 && r <= 55) {
                  ...
                  return (
                    (this.state.pos += s.length - 1), String.fromCharCode(o)
                  );
                }
          ...
          (t.prototype.readWord1 = function () {
            ...
            for (
              ...
              if (s(n)) this.state.pos += n <= 65535 ? 1 : 2;
                ...
                (e ? a : s)(o, !0) || this.raise(i, "Invalid Unicode escape"),
                  (t += l(o)),
                  (r = this.state.pos);
              }
              e = !1;
          ...
          (t.prototype.readWord = function () {
            var t = this.readWord1(),
              e = k.name;
            return (
              !this.state.containsEsc && this.isKeyword(t) && (e = j[t]),
      ...
      G = (function (t) {
        ...
        return (
          ...
          (e.prototype.hasPlugin = function (t) {
            return (
              !!(this.plugins["*"] && J.indexOf(t) > -1) || !!this.plugins[t]
            );
          }),
    ...
    (z.addExtra = function (t, e, r) {
      ...
      (z.expectRelational = function (t) {
        this.isRelational(t)
          ? this.next()
          : this.unexpected(null, k.relational);
      }),
      ...
      (z.canInsertSemicolon = function () {
        return (
          this.match(k.eof) ||
          this.match(k.braceR) ||
          I.test(this.input.slice(this.state.lastTokEnd, this.state.start))
        );
      }),
    ...
    (H.stmtToDirective = function (t) {
      ...
      (H.parseStatement = function (t, e) {
        ...
        switch (r) {
          ...
          case k.name:
            if ("async" === this.state.value) {
              ...
              if (
                (this.next(),
                this.match(k._function) && !this.canInsertSemicolon())
              )
                return (
                  this.expect(k._function), this.parseFunction(n, !0, !1, !0)
                );
              this.state = i;
            }
        }
        ...
        return r === k.name && "Identifier" === s.type && this.eat(k.colon)
          ? this.parseLabeledStatement(n, a, s)
      ...
      (H.parseForStatement = function (t) {
        ...
        if (this.match(k._var) || this.match(k._let) || this.match(k._const)) {
          ...
          return (
            ...
            (!this.match(k._in) && !this.isContextual("of")) ||
        ...
        if (this.match(k._in) || this.isContextual("of")) {
          var s = this.isContextual("of")
            ? "for-of statement"
            : "for-in statement";
          return (
            this.toAssignable(a, void 0, s),
      ...
      (H.parseForIn = function (t, e, r) {
        ...
        return (
          r
            ...
            : ((n = this.match(k._in) ? "ForInStatement" : "ForOfStatement"),
              this.next()),
          (t.left = e),
        ...
        for (t.declarations = [], t.kind = r.keyword; ; ) {
          ...
          if (
            ...
            this.eat(k.eq)
              ...
              : r !== k._const || this.match(k._in) || this.isContextual("of")
              ? "Identifier" === n.id.type ||
                (e && (this.match(k._in) || this.isContextual("of")))
                ? (n.init = null)
                : this.raise(
      ...
      (H.parseFunction = function (t, e, r, n, i) {
        ...
        return (
          ...
          !e ||
            ...
            this.match(k._yield) ||
            this.unexpected(),
          (this.match(k.name) || this.match(k._yield)) &&
      ...
      (H.parseClassBody = function (t) {
        ...
        for (a.body = [], this.expect(k.braceL); !this.eat(k.braceR); )
          if (this.eat(k.semi))
            ...
            if (
              (i.length && ((s.decorators = i), (i = [])),
              (s.static = !1),
              this.match(k.name) && "static" === this.state.value)
            ) {
            ...
            if (this.eat(k.star))
              (s.kind = "method"),
                ...
                this.isNonstaticConstructor(s) &&
                  this.raise(s.key.start, "Constructor can't be a generator"),
                s.computed ||
                  !s.static ||
                  ("prototype" !== s.key.name && "prototype" !== s.key.value) ||
                  this.raise(
                    s.key.start,
              ...
              if (
                ...
                (this.isLineTerminator() && this.match(k.star))
      ...
      (H.parseExport = function (t) {
        if ((this.next(), this.match(k.star))) {
          ...
          if (
            ...
            this.match(k.comma) && this.lookahead().type === k.star)
          ) {
            this.expect(k.comma);
            var n = this.startNode();
            this.expect(k.star),
        ...
        return (
          this.checkExport(t, !0), this.finishNode(t, "ExportNamedDeclaration")
        );
      }),
        ...
        if (e)
          if (r) this.checkDuplicateExports(t, "default");
            ...
            if (
              ...
              for (
                var u = t.declaration.declarations,
                  c = Array.isArray(u),
                  l = 0,
                  u = c ? u : u[Symbol.iterator]();
                ;
    ...
    (tt.toAssignable = function (t, e, r) {
      ...
      (tt.shouldAllowYieldIdentifier = function () {
        return (
          this.match(k._yield) && !this.state.strict && !this.state.inGenerator
        );
      }),
      ...
      (tt.parseBindingList = function (t, e) {
        for (var r = [], n = !0; !this.eat(t); )
          if ((n ? (n = !1) : this.expect(k.comma), e && this.match(k.comma)))
            r.push(null);
          else {
            if (this.eat(t)) break;
    ...
    (et.checkPropClash = function (t, e) {
      if (!t.computed && !t.kind) {
        var r = t.key;
        "__proto__" === ("Identifier" === r.type ? r.name : String(r.value)) &&
          (e.proto && this.raise(r.start, "Redefinition of __proto__ property"),
          (e.proto = !0));
      }
    }),
      ...
      (et.parseExpression = function (t, e) {
        ...
        if (this.match(k.comma)) {
          ...
          for (a.expressions = [i]; this.eat(k.comma); )
      ...
      (et.parseMaybeAssign = function (t, e, r, n) {
        ...
        var o = void 0;
        e ? (o = !1) : ((e = { start: 0 }), (o = !0)),
          (this.match(k.parenL) || this.match(k.name)) &&
      ...
      (et.parseSubscripts = function (t, e, r, n) {
        for (;;) {
          ...
          if (this.eat(k.dot)) {
            ...
            if (
              ((u.callee = t),
              (u.arguments = this.parseCallExpressionArguments(k.parenR, o)),
      ...
      (et.parseAsyncArrowFromCallExpression = function (t, e) {
        return (
          this.expect(k.arrow), this.parseArrowExpression(t, e.arguments, !0)
        );
      }),
      ...
      (et.parseExprAtom = function (t) {
        ...
        switch (this.state.type) {
          ...
          case k.name:
            ...
            if ("await" === a.name) {
              ...
              if (e && "async" === a.name && this.match(k.name)) {
                ...
                return (
                  this.expect(k.arrow), this.parseArrowExpression(r, s, !0)
                );
              }
            }
            return e && !this.canInsertSemicolon() && this.eat(k.arrow)
              ? this.parseArrowExpression(r, [a])
              : a;
          case k._do:
          ...
          case k.regexp:
            ...
            return (
              (r = this.parseLiteral(l.value, "RegExpLiteral")),
              (r.pattern = l.pattern),
              (r.flags = l.flags),
              r
            );
      ...
      (et.parseMetaProperty = function (t, e, r) {
        return (
          ...
          t.property.name !== r &&
            this.raise(
              t.property.start,
              "The only valid meta property for new is " + e.name + "." + r
            ),
      ...
      (et.parseParenAndDistinguishExpression = function (t, e, r) {
        ...
        for (
          ...
          if (c) c = !1;
            ...
            (this.expect(k.comma, u.start || null), this.match(k.parenR))
          ) {
            p = this.state.start;
            break;
          }
        ...
        if (r && this.shouldParseArrow() && (m = this.parseArrow(m))) {
          for (
            ...
            D.extra &&
              ...
              this.unexpected(D.extra.parenStart);
          }
          return this.parseArrowExpression(m, s);
        }
        return (
          s.length || this.unexpected(this.state.lastTokStart),
          p && this.unexpected(p),
          l && this.unexpected(l),
          o.start && this.unexpected(o.start),
          u.start && this.unexpected(u.start),
          s.length > 1
            ? ((n = this.startNodeAt(i, a)),
              (n.expressions = s),
              this.toReferencedList(n.expressions),
              this.finishNodeAt(n, "SequenceExpression", d, y))
            : (n = s[0]),
      ...
      (et.parseNew = function () {
        ...
        return (
          ...
          this.eat(k.parenL)
            ? ((t.arguments = this.parseExprList(k.parenR)),
      ...
      (et.parseObj = function (t, e) {
        ...
        for (var s = null; !this.eat(k.braceR); ) {
          ...
          if (
            ...
            this.hasPlugin("objectRestSpread") && this.match(k.ellipsis))
          ) {
            if (
              ((o = this.parseSpread(t ? { start: 0 } : void 0)),
              (o.type = t ? "RestProperty" : "SpreadProperty"),
            ...
            if (null === s) {
              ...
              if (this.match(k.comma) && this.lookahead().type === k.braceR)
                continue;
              s = f;
              continue;
            }
          ...
          if (
            ...
            this.match(k.eq) ||
            this.match(k.comma)
              ? ((o.key = h), (o.computed = !1))
              : ((c = !0),
                this.hasPlugin("asyncGenerators") && (u = this.eat(k.star)),
      ...
      (et.parseObjectMethod = function (t, e, r, n) {
        return r || e || this.match(k.parenL)
          ? (n && this.unexpected(),
            (t.kind = "method"),
            (t.method = !0),
            this.parseMethod(t, e, r),
            this.finishNode(t, "ObjectMethod"))
          : this.isGetterOrSetterMethod(t, n)
          ? ((e || r) && this.unexpected(),
            (t.kind = t.key.name),
      ...
      (et.parseObjPropValue = function (t, e, r, n, i, a, s) {
        var o =
          this.parseObjectMethod(t, n, i, a) ||
          this.parseObjectProperty(t, e, r, a, s);
      ...
      (et.parseFunctionBody = function (t, e) {
        ...
        if (((this.state.inAsync = t.async), r))
        ...
        if (
          ...
          for (
            ...
            o &&
              "Identifier" !== y.type &&
              this.raise(y.start, "Non-simple parameter in strict mode"),
      ...
      (et.parseExprListItem = function (t, e, r) {
        return t && this.match(k.comma)
          ? null
          : this.match(k.ellipsis)
          ? this.parseSpread(e)
          : this.parseMaybeAssign(!1, e, this.parseParenItem, r);
      }),
      ...
      (et.checkReservedWord = function (t, e, r, n) {
        (this.isReservedWord(t) || (r && this.isKeyword(t))) &&
          this.raise(e, t + " is a reserved word"),
          this.state.strict &&
            (v.strict(t) || (n && v.strictBind(t))) &&
      ...
      (et.parseYield = function () {
        ...
        return (
          ...
          this.match(k.semi) ||
          this.canInsertSemicolon() ||
          (!this.match(k.star) && !this.state.type.startsExpr)
            ? ((t.delegate = !1), (t.argument = null))
            : ((t.delegate = this.eat(k.star)),
        ...
        if (!("Program" === t.type && t.body.length > 0)) {
          ...
          if (this.state.trailingComments.length > 0)
            ...
            e.length > 0 &&
              ...
              ((i = o.trailingComments), (o.trailingComments = null));
          }
          for (
            e.length > 0 && f(e).start >= t.start && (r = e.pop());
          ...
          if (n) {
            if (n.leadingComments)
              if (n !== t && f(n.leadingComments).end <= t.start)
                (t.leadingComments = n.leadingComments),
          ...
          t.extend("parseMethod", function (t) {
            return function (e) {
              ...
              for (
                ...
                i[a - 1] = arguments[a];
              return (
                (r = t.call.apply(t, [this, r].concat(i))),
                delete r.kind,
          ...
          t.extend("toAssignable", function (t) {
            return function (e, r) {
              for (
                ...
                i[a - 2] = arguments[a];
              if (h(e))
                return this.toAssignable.apply(this, [e.value, r].concat(i)), e;
              if ("ObjectExpression" === e.type) {
                ...
                for (
                  ...
                  "get" === l.kind || "set" === l.kind
                    ...
                    : this.toAssignable(l, r, "object destructuring pattern");
                }
                return e;
              }
    ...
    (ct.flowParseTypeInitialiser = function (t) {
      ...
      (ct.flowParsePredicate = function () {
        ...
        return (
          ...
          (e.line === n.line && e.column === n.column - 1) ||
            this.raise(
              r,
              "Spaces between \xb4%\xb4 and \xb4checks\xb4 are not allowed here."
            ),
          this.eat(k.parenL)
        ...
        return (
          this.match(k.modulo)
            ...
            : ((e = this.flowParseType()),
              (this.state.inType = t),
              this.match(k.modulo) && (r = this.flowParsePredicate())),
          [e, r]
        );
      }),
      ...
      (ct.flowParseOpaqueType = function (t, e) {
        return (
          ...
          (t.supertype = null),
          this.match(k.colon) &&
            (t.supertype = this.flowParseTypeInitialiser(k.colon)),
          (t.impltype = null),
      ...
      (ct.flowParseTypeParameter = function () {
        ...
        return (
          ...
          this.match(k.eq) &&
            (this.eat(k.eq), (t.default = this.flowParseType())),
      ...
      (ct.flowParseTypeParameterDeclaration = function () {
        ...
        (e.params = []),
          (this.state.inType = !0),
          this.isRelational("<") || this.match(k.jsxTagStart)
            ? this.next()
            : this.unexpected();
        do {
      ...
      (ct.flowParseObjectPropertyKey = function () {
        return this.match(k.num) || this.match(k.string)
          ? this.parseExprAtom()
          : this.parseIdentifier(!0);
      }),
        ...
        for (
          t.params = [],
            ...
            this.isRelational("<") &&
              (t.typeParameters = this.flowParseTypeParameterDeclaration()),
            this.expect(k.parenL);
          !this.match(k.parenR) && !this.match(k.ellipsis);

        )
          t.params.push(this.flowParseFunctionTypeParam()),
            this.match(k.parenR) || this.expect(k.comma);
        return (
          this.eat(k.ellipsis) && (t.rest = this.flowParseFunctionTypeParam()),
          this.expect(k.parenR),
      ...
      (ct.flowParseObjectType = function (t, e, r) {
        ...
        var u = void 0,
          c = void 0;
        for (
          e && this.match(k.braceBarL)
            ? (this.expect(k.braceBarL), (u = k.braceBarR), (c = !0))
            : (this.expect(k.braceL), (u = k.braceR), (c = !1)),
            i.exact = c;
          !this.match(u);
          ...
          this.match(k.bracketL)
            ? i.indexers.push(this.flowParseObjectTypeIndexer(a, o, d))
            : this.match(k.parenL) || this.isRelational("<")
            ? (d && this.unexpected(h),
              i.callProperties.push(this.flowParseObjectTypeCallProperty(a, o)))
            : this.match(k.ellipsis)
            ? (r ||
                this.unexpected(
                  null,
              ...
              this.flowObjectTypeSemicolon(),
              i.properties.push(this.finishNode(a, "ObjectTypeSpreadProperty")))
            : ((s = this.flowParseObjectPropertyKey()),
              this.isRelational("<") || this.match(k.parenL)
                ? (d && this.unexpected(d.start),
                  i.properties.push(this.flowParseObjectTypeMethod(p, f, o, s)))
                : (this.eat(k.question) && (l = !0),
                  (a.key = s),
                  ...
                  (a.variance = d),
                  this.flowObjectTypeSemicolon(),
                  i.properties.push(this.finishNode(a, "ObjectTypeProperty")))),
            (o = !1);
        }
        this.expect(u);
      ...
      (ct.flowParseTupleType = function () {
        var t = this.startNode();
        for (
          t.types = [], this.expect(k.bracketL);
          this.state.pos < this.input.length &&
          !this.match(k.bracketR) &&
          (t.types.push(this.flowParseType()), !this.match(k.bracketR));

        )
          this.expect(k.comma);
        return (
          this.expect(k.bracketR), this.finishNode(t, "TupleTypeAnnotation")
        );
      }),
      (ct.flowParseFunctionTypeParam = function () {
        var t = null,
          ...
          i = this.lookahead();
        return (
          i.type === k.colon || i.type === k.question
            ? ((t = this.parseIdentifier()),
              this.eat(k.question) && (e = !0),
      ...
      (ct.flowParseFunctionTypeParams = function () {
        for (
          ...
          e.params.push(this.flowParseFunctionTypeParam()),
            this.match(k.parenR) || this.expect(k.comma);
        return (
          this.eat(k.ellipsis) && (e.rest = this.flowParseFunctionTypeParam()),
          e
        );
      }),
      ...
      (ct.flowParsePrimaryType = function () {
        ...
        switch (this.state.type) {
            ...
            if (a) {
              if (
                ...
                this.state.noAnonFunctionType ||
                  !(
                    this.match(k.comma) ||
                    (this.match(k.parenR) && this.lookahead().type === k.arrow)
                  ))
              )
                return this.expect(k.parenR), i;
              this.eat(k.comma);
            }
            return (
              (n = i
          ...
          case k._null:
            return (
              (r.value = this.match(k._null)),
              this.next(),
              this.finishNode(r, "NullLiteralTypeAnnotation")
            );
          case k._this:
            return (
              (r.value = this.match(k._this)),
              this.next(),
      ...
      (ct.flowParsePostfixType = function () {
        for (
          ...
          !this.canInsertSemicolon() && this.match(k.bracketL);
      ...
      (ct.flowParseIntersectionType = function () {
        ...
        for (t.types = [e]; this.eat(k.bitwiseAND); )
      ...
      (ct.flowParseUnionType = function () {
        ...
        for (t.types = [e]; this.eat(k.bitwiseOR); )
        ...
        t.extend("parseFunctionBody", function (t) {
              ...
              if (a && this.match(k.question)) {
                ...
                try {
                  ...
                  if (t instanceof SyntaxError)
                    return (
                      (this.state = s), (a.start = t.pos || this.state.start), e
                    );
                  throw t;
                }
              }
          ...
          t.extend("parseParenItem", function (t) {
            return function (e, r, n) {
              if (
                ((e = t.call(this, e, r, n)),
                this.eat(k.question) && (e.optional = !0),
                this.match(k.colon))
              ) {
                var i = this.startNodeAt(r, n);
                return (
          ...
          t.extend("toAssignable", function (t) {
            return function (e, r, n) {
              return "TypeCastExpression" === e.type
                ? t.call(this, this.typeCastToParameter(e), r, n)
                : t.call(this, e, r, n);
            };
          }),
          ...
          t.extend("parseObjPropValue", function (t) {
            return function (e) {
              ...
              this.isRelational("<") &&
                ...
                this.match(k.parenL) || this.unexpected()),
                t.apply(this, arguments),
          ...
          t.extend("parseImportSpecifiers", function (t) {
            return function (e) {
              ...
              var r = null;
              if (
                (this.match(k._typeof)
                  ? (r = "typeof")
                  : this.isContextual("type") && (r = "type"),
                r)
              ) {
                var n = this.lookahead();
                ((n.type === k.name && "from" !== n.value) ||
                  n.type === k.braceL ||
                  n.type === k.star) &&
                  (this.next(), (e.importKind = r));
              }
              t.call(this, e);
            };
          }),
          t.extend("parseImportSpecifier", function () {
            return function (t) {
              ...
              if (this.isContextual("as")) {
                ...
                null === i || this.match(k.name) || this.state.type.keyword
                  ? ((e.imported = n),
                    (e.importKind = null),
                    (e.local = this.parseIdentifier()))
                  : ((e.imported = s),
          ...
          t.extend("parseMaybeAssign", function (t) {
            return function () {
              for (
                var e = null, r = arguments.length, n = Array(r), i = 0;
                i < r;
                i++
              )
                n[i] = arguments[i];
    ...
    if (!pt) {
      ...
      pt = function () {
        ...
        for (var a = ""; ++n < i; ) {
          ...
          if (!isFinite(s) || s < 0 || s > 1114111 || ht(s) != s)
          ...
          s <= 65535
            ...
            : ((s -= 65536),
              ...
              (r = (s % 1024) + 56320),
              t.push(e, r)),
            (n + 1 == i || t.length > 16384) &&
              ((a += ft.apply(null, t)), (t.length = 0));
        }
        return a;
      };
    }
    ...
    (U.j_oTag = new M("<tag", !1)),
      ...
      (k.jsxText = new O("jsxText", { beforeExpr: !0 })),
      (k.jsxTagStart = new O("jsxTagStart", { startsExpr: !0 })),
      ...
      (k.jsxTagEnd.updateContext = function (t) {
        ...
        (e === U.j_oTag && t === k.slash) || e === U.j_cTag
          ? (this.state.context.pop(),
    ...
    (bt.jsxReadToken = function () {
          ...
          case 123:
            return this.state.pos === this.state.start
              ? 60 === r && this.state.exprAllowed
                ? (++this.state.pos, this.finishToken(k.jsxTagStart))
                : this.getTokenFromCode(r)
              : ((t += this.input.slice(e, this.state.pos)),
                this.finishToken(k.jsxText, t));
          case 38:
            (t += this.input.slice(e, this.state.pos)),
      ...
      (bt.jsxReadEntity = function () {
        for (
          ...
          if (";" === (n = this.input[this.state.pos++])) {
            "#" === t[0]
              ? "x" === t[1]
                ? ((t = t.substr(2)), mt.test(t) && (r = dt(parseInt(t, 16))))
                : ((t = t.substr(1)), vt.test(t) && (r = dt(parseInt(t, 10))))
              : (r = yt[t]);
            break;
          }
          t += n;
      ...
      (bt.jsxParseAttributeValue = function () {
        ...
        switch (this.state.type) {
          case k.braceL:
            if (
              ((t = this.jsxParseExpressionContainer()),
      ...
      (bt.jsxParseAttribute = function () {
        ...
        return this.eat(k.braceL)
          ...
          : ((t.name = this.jsxParseNamespacedName()),
            (t.value = this.eat(k.eq) ? this.jsxParseAttributeValue() : null),
      ...
      (bt.jsxParseOpeningElementAt = function (t, e) {
        ...
        for (
          ...
          !this.match(k.slash) && !this.match(k.jsxTagEnd);

        )
          r.attributes.push(this.jsxParseAttribute());
        return (
          (r.selfClosing = this.eat(k.slash)),
          ...
          t: for (;;)
            switch (this.state.type) {
              ...
              case k.jsxText:
                ...
                break;
              case k.braceL:
                this.lookahead().type === k.ellipsis
    ...
    var At = function (t) {
      t.extend("parseExprAtom", function (t) {
        return function (e) {
          ...
          return this.match(k.jsxTagStart)
        ...
        t.extend("readToken", function (t) {
          return function (e) {
            ...
            if (r === U.j_oTag || r === U.j_cTag) {
              ...
              if (62 === e)
                return ++this.state.pos, this.finishToken(k.jsxTagEnd);
              if ((34 === e || 39 === e) && r === U.j_oTag)
        ...
        t.extend("updateContext", function (t) {
          return function (e) {
            if (this.match(k.braceL)) {
              ...
              if (!this.match(k.slash) || e !== k.jsxTagStart)
                return t.call(this, e);
    ...
    (function (t, r) {
      ...
      function J(t) {
        ...
        for (var r in Object(t))
          ve.call(t, r) && "constructor" != r && e.push(r);
        return e;
      }
      function G(t, e) {
        if (e) return t.slice();
      ...
      var qe = _e ? f(_e, Object) : Ft,
        Ke = W;
      ((Pe && Ke(new Pe(new ArrayBuffer(1))) != Kt) ||
        (Oe && Ke(new Oe()) != It) ||
        (Be && "[object Promise]" != Ke(Be.resolve())) ||
        (Ne && Ke(new Ne()) != Ut) ||
        (ke && "[object WeakMap]" != Ke(new ke()))) &&
        (Ke = function (t) {
          var e = be.call(t),
  ...
  function (t, e, r) {
    function n(t) {
      ...
      var e = a(t),
        r = [];
      for (var n in t)
        ("constructor" != n || (!e && u.call(t, n))) && r.push(n);
      return r;
    }
    var i = r(12),
      a = r(62),
  ...
  function (t, e, r) {
    function n(t, e, r) {
      return (
        ...
        function () {
          for (
            var n = arguments, s = -1, o = a(n.length - e, 0), u = Array(o);
            ++s < o;
  ...
  function (t, e, r) {
    ...
    function c(t, e, r) {
      return "string" === typeof e || "number" === typeof e
        ...
        : r || t._componentConstructor === e.nodeName;
    }
    function l(t, e) {
      return (
      ...
      if (("className" === e && (e = "class"), "key" === e));
        ...
        if ("style" === e) {
          ...
          (e = e.toLowerCase().substring(2)),
            n
              ? r || t.addEventListener(e, m, s)
              : t.removeEventListener(e, m, s),
    ...
    function A(t, e, r, n, i) {
        ...
        return (
          t && void 0 !== t.splitText && t.parentNode && (!t._component || i)
            ...
            : ((a = document.createTextNode(e)),
              t && (t.parentNode && t.parentNode.replaceChild(a, t), D(t, !0))),
          (a.__preactattr_ = !0),
          a
        );
      var o = e.nodeName;
      ...
      if (null == c) {
        c = a.__preactattr_ = {};
        for (var h = a.attributes, d = h.length; d--; )
      ...
      return (
        ...
        null == u.nextSibling
          ...
          : ((p && p.length) || null != u) &&
            E(a, p, r, n, Y || null != c.dangerouslySetInnerHTML),
        g(a, e.attributes, c),
        (V = s),
        a
      );
    ...
    function E(t, e, r, n, i) {
      ...
      if (0 !== v)
        for (var x = 0; x < v; x++) {
          ...
          null != w
            ? (y++, (d[w] = g))
            : (C || (void 0 !== g.splitText ? !i || g.nodeValue.trim() : i)) &&
              (f[b++] = g);
        }
      if (0 !== E)
        for (var x = 0; x < E; x++) {
          ...
          var w = u.key;
          if (null != w)
            y && void 0 !== d[w] && ((l = d[w]), (d[w] = void 0), y--);
          else if (!l && m < b)
            for (a = m; a < b; a++)
    ...
    function g(t, e, r) {
      ...
      for (n in r)
        (e && null != e[n]) ||
          null == r[n] ||
          d(t, n, r[n], (r[n] = void 0), V);
      for (n in e)
        "children" === n ||
          "innerHTML" === n ||
          (n in r &&
            e[n] === ("value" === n || "checked" === n ? t[n] : r[n])) ||
          d(t, n, r[n], (r[n] = e[n]), V);
    }
    function C(t) {
    ...
    function w(t, e, r) {
      ...
      if (
        (t.prototype && t.prototype.render
          ? ((n = new t(e, r)), O.call(n, e, r))
          : ((n = new O(e, r)), (n.constructor = t), (n.render = F)),
        i)
      )
      ...
      if (!t._disable) {
        ...
        if (
          (y &&
            ...
            !1 === t.shouldComponentUpdate(u, c, l)
              ? (x = !0)
              : t.componentWillUpdate && t.componentWillUpdate(u, c, l),
            (t.props = u),
            (t.state = c),
            (t.context = l)),
          ...
          (i = t.render(u, c, l)),
            t.getChildContext && (l = a(a({}, l), t.getChildContext()));
          var g,
            C,
            F = i && i.nodeName;
          if ("function" === typeof F) {
            var S = p(i);
            (s = E),
              s && s.constructor === F && S.key == s.__key
                ? _(s, S, 1, l, !1)
                : ((g = s),
                  (t._component = s = w(F, S, l)),
            ...
            (o = A),
              ...
              (A || 1 === e) &&
                (o && (o._component = null),
                (C = b(o, i, l, r || !y, A && A.parentNode, !0)));
          if (A && C !== A && s !== E) {
            var O = A.parentNode;
            O &&
              C !== O &&
              (O.replaceChild(C, A), g || ((A._component = null), D(A, !1)));
          }
        ...
        if (
          (!y || r
            ? M.unshift(t)
            : x ||
              (t.componentDidUpdate && t.componentDidUpdate(f, h, d),
    ...
    function S(t, e, r, n) {
      ...
      return (
        i && u && (!n || i._component)
          ? (_(i, c, 3, r, n), (t = i.base))
          : (a && !o && (P(a), (t = s = null)),
            (i = w(e.nodeName, c, r)),
            t && !i.nextBase && ((i.nextBase = t), (s = null)),
            _(i, c, 1, r, n),
            (t = i.base),
            s && t !== s && ((s._component = null), D(s, !1))),
        t
      );
    }
    function P(t) {
    ...
    a(O.prototype, {
      setState: function (t, e) {
        var r = this.state;
        this.prevState || (this.prevState = a({}, r)),
  ...
  function (t, e) {
    ...
    function s() {
      y &&
        h &&
        ((y = !1), h.length ? (d = h.concat(d)) : (m = -1), d.length && o());
    }
    function o() {
      if (!y) {
        var t = i(s);
  ...
  function (t, e, r) {
    ...
    function i(t) {
      function e(e) {
        (t.allRejections || s(p[e].error, t.whitelist || u)) &&
          ((p[e].displayId = l++),
          t.onUnhandled
            ? ((p[e].logged = !0), t.onUnhandled(p[e].displayId, p[e].error))
            : ((p[e].logged = !0), a(p[e].displayId, p[e].error)));
      }
      function r(e) {
        p[e].logged &&
          (t.onHandled
            ? t.onHandled(p[e].displayId, p[e].error)
            : p[e].onUnhandled ||
              (console.warn(
                "Promise Rejection Handled (id: " + p[e].displayId + "):"
              ),
              console.warn(
      ...
      (o._10 = function (t) {
        2 === t._81 &&
          p[t._72] &&
          (p[t._72].logged ? r(t._72) : clearTimeout(p[t._72].timeout),
          delete p[t._72]);
      }),
        (o._97 = function (t, r) {
          0 === t._45 &&
  ...
  function (t, e, r) {
    ...
    e.a = (function () {
      ...
      return (
        ...
        (l.childContextTypes =
          ((t = {}), (t[e] = c.a.isRequired), (t[o] = c.b), t)),
        l
      );
    })();
  },
  ...
  function (t, e, r) {
    ...
    function a(t, e, r, n, i) {
      ...
      function s() {
        return (
          (m = t(d, y)), e.dependsOnOwnProps && (v = e(n, y)), (b = r(m, v, y))
        );
      }
      function o() {
        return (
          t.dependsOnOwnProps && (m = t(d, y)),
  ...
  function (t, e, r) {
    ...
    function i(t) {
      Object.keys(t).forEach(function (e) {
        var r = t[e];
        if ("undefined" === typeof r(void 0, { type: s.b.INIT }))
          throw new Error(
            'Reducer "' +
              e +
  ...
  function (t, e, r) {
    (function (e) {
      ...
      if (((n.regeneratorRuntime = void 0), (t.exports = r(350)), i))
        ...
        function c(t, e, r) {
          ...
          return function (a, s) {
            ...
            for (r.method = a, r.arg = s; ; ) {
              ...
              "throw" === c.type &&
                ((i = T), (r.method = "throw"), (r.arg = c.arg));
            }
          };
        }
        function l(t, e) {
          ...
          (h.prototype = {
            ...
            finish: function (t) {
              for (var e = this.tryEntries.length - 1; e >= 0; --e) {
                ...
                if (r.finallyLoc === t)
                  return this.complete(r.completion, r.afterLoc), f(r), S;
              }
            },
            catch: function (t) {
              for (var e = this.tryEntries.length - 1; e >= 0; --e) {
        ...
        return (
          ...
          (this._initBody = function (t) {
            if (((this._bodyInit = t), t))
              ...
              else if (v.arrayBuffer && v.blob && A(t))
                (this._bodyArrayBuffer = l(t.buffer)),
                  (this._bodyInit = new Blob([this._bodyArrayBuffer]));
              else {
                if (
                  !v.arrayBuffer ||
                  (!ArrayBuffer.prototype.isPrototypeOf(t) && !E(t))
                )
