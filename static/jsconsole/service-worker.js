...
var precacheConfig = [["/static/jsconsole/main.css", "adbb4ffbb7eeb4a451409de79cc095eb"], ["/static/jsconsole/main.js", "fe8f57582ac8f222790cd9c90bbf8743"]],
...
function(e) {
    if ("GET" === e.request.method) {
        var t, n = stripIgnoredUrlParameters(e.request.url, ignoreUrlParametersMatching); (t = urlsToCacheKeys.has(n)) || (n = addDirectoryIndex(n, "index.html"), t = urlsToCacheKeys.has(n)); ! t && "navigate" === e.request.mode && isPathWhitelisted(["^(?!\\/__).*"], e.request.url) && (n = new URL("/index.html", self.location).toString(), t = urlsToCacheKeys.has(n)),
